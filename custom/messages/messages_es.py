...
MESSAGES = {
    ...
    "Read more": "Leer más",
    "Source": "El código de este artículo está disponible en ",
    "Source2": "¿Encontraste un error? Por favor, ",
    "Source3": "enviame un pull request",
    "Theme auto tooltip": "Tema: Automático (sistema). Click para pasar a claro.",
    "Theme light tooltip": "Tema: Claro. Click para pasar a oscuro.",
    "Theme dark tooltip": "Tema: Oscuro. Click para pasar a automático.",
